...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //cambiar el nombre del raw por el del video
        //Solo acepta minusculas, si el nombre del archivo lleva mayusculas da errores
        uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.la_vaguelette_by_hoyo_mix);
